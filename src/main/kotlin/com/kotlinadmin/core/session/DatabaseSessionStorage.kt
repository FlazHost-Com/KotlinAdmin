...
class DatabaseSessionStorage(private val ttlSeconds: Long = 7 * 24 * 3600L) : SessionStorage {
    ...
    override suspend fun read(id: String): String {
        return DatabaseConfig.dbQuery {
            Sessions.selectAll()
                ...
                .firstOrNull()
                ?.let { row ->
                    if (row[Sessions.expiresAt].isBefore(LocalDateTime.now())) null
                    else row[Sessions.data]
                }
